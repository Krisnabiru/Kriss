...
creator = ["uac44837d56e41d7aa87a08e0035f436a"]
Owner = ["uac44837d56e41d7aa87a08e0035f436a"]
admin = ["uac44837d56e41d7aa87a08e0035f436a"]
    ...
    try:
        ...
        if op.type == 5:
            ...
            if settings["autoAdd"] == True:
                nadya.sendMessage(op.param1, "Hai aku Kriss, thanks for adding".format(str(nadya.getContact(op.param1).displayName)))
        if op.type == 13:
...
#==============================================================================#
                  ...
                  if msg._from in Owner:    
                    ...
                    try:
                        ...
                        ret_ += "\n╚══[ Dilarang remake tanpa izin cok :P ]"
...
#-------------------------------------------------------------------------------
    ...
    #                       nadya.sendMessage(msg.to,"「 Sorry guys 」")
                            targets = []
                            for g in gs.members:
